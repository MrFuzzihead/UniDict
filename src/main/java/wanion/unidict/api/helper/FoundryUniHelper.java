...
public final class FoundryUniHelper {
    ...
    public static void removeMold(ItemStack removeTarget) {
        ...
        for (Iterator<ICastingRecipe> castingRecipeIterator = CastingRecipeManager.instance.recipes
            .iterator(); castingRecipeIterator.hasNext();)
            if (MetaItem.get(
                castingRecipeIterator.next()
                    .GetInputMold())
                == targetHash) castingRecipeIterator.remove();
    ...
    public static void removeCast(ItemStack removeTarget) {
        ...
        for (Iterator<ICastingRecipe> castingRecipeIterator = CastingRecipeManager.instance.recipes
            .iterator(); castingRecipeIterator.hasNext();)
            if ((bufferRecipe = castingRecipeIterator.next()) != null
                && (MetaItem.get(bufferRecipe.GetInputMold()) == targetHash
                    || MetaItem.get(bufferRecipe.GetOutputItem()) == targetHash))
