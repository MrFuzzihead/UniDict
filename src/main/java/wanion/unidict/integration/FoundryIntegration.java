...
final class FoundryIntegration extends AbstractIntegrationThread {
    ...
    private void fixAlloyFurnaceRecipes() {
        ...
        for (final Iterator<IAlloyFurnaceRecipe> alloyFurnaceRecipeIterator = alloyFurnaceRecipes
            .iterator(); alloyFurnaceRecipeIterator.hasNext();) {
            ...
            newRecipes
                .add(new AlloyFurnaceRecipe(correctOutput, atomizerRecipe.GetInputA(), atomizerRecipe.GetInputB()));
    ...
    private void fixAtomizerRecipes() {
        ...
        for (final Iterator<IAtomizerRecipe> atomizerRecipeIterator = atomizerRecipes.iterator(); atomizerRecipeIterator
            .hasNext();) {
            ...
            if (output instanceof ItemStack) {
                ...
                if (correctOutput == output) continue;
    ...
    private void fixCastingRecipes() {
        ...
        for (final Iterator<ICastingRecipe> castingRecipeIterator = castingRecipes.iterator(); castingRecipeIterator
            .hasNext();) {
            ...
            if (output instanceof ItemStack) {
                ...
                newRecipes.add(
                    new CastingRecipe(
                        correctOutput,
                        castingRecipe.GetInputFluid(),
                        castingRecipe.GetInputMold(),
                        null,
                        castingRecipe.GetCastingSpeed()));
