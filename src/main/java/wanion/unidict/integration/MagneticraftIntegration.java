...
final class MagneticraftIntegration extends AbstractIntegrationThread {
    ...
    private void fixCrusherRecipes() {
        ...
        newRecipes.addAll(
            crusherRecipeList.stream()
                .map(
                    crusherRecipe -> new RecipeCrusher(
                        resourceHandler.getMainItemStack(crusherRecipe.getInput()),
                        resourceHandler.getMainItemStack(crusherRecipe.getOutput()),
                        resourceHandler.getMainItemStack(crusherRecipe.getOutput2()),
                        crusherRecipe.getProb2(),
                        resourceHandler.getMainItemStack(crusherRecipe.getOutput3()),
                        crusherRecipe.getProb3()))
    ...
    private void fixGrinderRecipes() {
        ...
        newRecipes.addAll(
            grinderRecipeList.stream()
                .map(
                    grinderRecipe -> new RecipeGrinder(
                        resourceHandler.getMainItemStack(grinderRecipe.getInput()),
                        resourceHandler.getMainItemStack(grinderRecipe.getOutput()),
                        resourceHandler.getMainItemStack(grinderRecipe.getOutput2()),
                        grinderRecipe.getProb2(),
                        resourceHandler.getMainItemStack(grinderRecipe.getOutput3()),
                        grinderRecipe.getProb3()))
                .collect(Collectors.toList()));
    ...
    private void fixSifterRecipes() {
        ...
        newRecipes.addAll(
            sifterRecipeList.stream()
                .map(
                    sifterRecipe -> new RecipeSifter(
                        resourceHandler.getMainItemStack(sifterRecipe.getInput()),
                        resourceHandler.getMainItemStack(sifterRecipe.getOutput()),
                        resourceHandler.getMainItemStack(sifterRecipe.getExtra()),
                        sifterRecipe.getProb()))
                .collect(Collectors.toList()));
